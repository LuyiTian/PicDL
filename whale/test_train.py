# test_run
# https://github.com/dmlc/mxnet/blob/master/example/image-classification/train_imagenet.py
import mxnet as mx
import logging
import argparse
import train_model
...
parser.add_argument('--model-prefix', type=str, default="whale_train",
...
parser.add_argument('--num-examples', type=int, default=4544,
                    help='the number of training examples')
parser.add_argument('--num-classes', type=int, default=447,
