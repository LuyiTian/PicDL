...
class ImageUtilitiesUT(unittest.TestCase):
    ...
    def setUp(self):
        self.image_path = os.path.join(os.getcwd(), "resource", "sample", "test_image1.jpg")
    ...
    def test_resize_image(self):
        ...
        new_image = ImageUtilities.resize.resize_image(image, max_width = 1000, max_height = 1000)
        ImageUtilities.image_io.write_image(new_image, output_path)
